<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\work\tp\public/../application/index\view\game1\index.html";i:1552549377;s:45:"D:\work\tp\application\index\view\header.html";i:1552464527;s:45:"D:\work\tp\application\index\view\footer.html";i:1552464611;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div style="margin-top:20px;"  class="uk-grid">
	...
	<a href="/index.php/index/index/game">返回</a>
			
		<div class="uk-grid showmoney" >
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/er.jpg" width="" height="" alt=""> 
			</div>
			<p>搜集图片不易，仅需1毛即可观看</p>
		</div>
		...
		<div class="uk-grid showmoney" style="display:none">
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/1.jpg" width="" height="" alt=""> 
			</div>		
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/2.jpg" width="" height="" alt=""> 
			</div>	
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/3.jpg" width="" height="" alt=""> 
			</div>	
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/4.jpg" width="" height="" alt=""> 
			</div>	
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/5.jpg" width="" height="" alt=""> 
			</div>
			<div class="uk-width-5-6">
				<img  id = "op" class="click_money" src="/pic/1/6.jpg" width="" height="" alt=""> 
			</div>
		</div>
