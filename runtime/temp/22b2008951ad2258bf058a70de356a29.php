<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\work\tp\public/../application/index\view\contact\index.html";i:1545878511;s:45:"D:\work\tp\application\index\view\header.html";i:1545876353;s:45:"D:\work\tp\application\index\view\footer.html";i:1545620035;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<!--导航栏-->
<div style="">
    <div style="display:inline-table;margin-left: 10%;" class="mainimg">
        <nav class="uk-navbar">
    ...
    <div style="display:inline-table;margin-left: 15%   ;background-color: white" class="mainimg">
        <nav class="uk-navbar">
            <ul class="uk-navbar-nav uk-nav-sub " style="background-color: white">
                <li class="index"><a href="/index.php/index/index/index"><span class="">首页</span></a></li>
                <li	class="company"><a href="/index.php/index/index/company">公司简介</a></li>
                <li class="game"><a href="/index.php/index/index/game">游戏中心</a></li>
                <li class="news"><a href="/index.php/index/index/news">新闻中心</a></li>
                <li class="cooperation"><a href="/index.php/index/index/cooperation">商务合作</a></li>
                <li class="contact"><a href="/index.php/index/index/contact">联系我们</a></li>
            </ul>
        </nav>
...
<div style="margin-top:20px;"  class="uk-grid">
	...
	<div class="uk-slidenav-position uk-width-4-6" >
		<ul class="uk-tab" data-uk-tab>
			<li class="uk-active"><a onclick="javascript:addRecord(1)">人才招聘</a></li>
			<li><a onclick="javascript:addRecord(2)" >联系方式</a></li>
		</ul>
	</div>
	<div class="uk-slidenav-position uk-width-1-6"></div>	
</div>
			...
			<div style="">
				<article class="uk-article">
					<p class="uk-article-meta">
						...
						人力资源部：郑小姐<br/>
						座机：020-85200243<br/>
						邮箱：zhengfangyan@rodgm.com<br/>
						公司地址：广州市天河区龙口东路129号龙泽商业大厦1203A<br/>
					</p><br/>
					<iframe src="map.html" width="800px" height="500px" frameborder="0" scrolling="no"></iframe>
...
<div class="footer uk-block uk-block-primary uk-contrast " style="background-color: white">
    <div class="uk-container " style="margin-left: 15%">
        <div class="uk-grid uk-grid-match" data-uk-grid-margin>
            <div class="uk-width-medium-1-3 uk-row-first">
                <div class="uk-panel mainimg">
                    <img src="/pic/1.png">
                </div>
            </div>
            <div class="uk-width-medium-1-3 uk-row-first uk-contrast">
                <div class="uk-panel" style="color: black">
                    <h3  style="color: black">联系我们</h3>
                    <p>公司地址：XXXXXXXXXXXXXXXX</p>
                    <p>联系电话：123456789</p>
                    <p>电子邮箱：XXXXXXXXXXXXXXXXXX</p>
                </div>
            </div>
            <div class="uk-width-medium-1-3 uk-row-first">
                <div class="uk-panel"  style="color: black">
